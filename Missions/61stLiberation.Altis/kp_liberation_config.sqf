...
KPLIB_transportConfigs = [
    ...
    ["OPTRE_m1087_stallion_unsc", -6.5, [0,-0.9,0.45], [0,-2.5,0.45], [0,-4.1,0.45]],
    ["OPTRE_Pelican_unarmed", -6.5, [0,5.4,-2.2], [0,3.7,-2.2], [0,2,-2.2], [-0.8,-2.6,0.1], [0.8,-2.6,0.1], [-0.8,-4.2,0.1], [0.8,-4.2,0.1], [-0.8,-5.8,0.1], [0.8,-5.8,0.1]],
    ["OPTRE_Pelican_armed", -6.5, [0,5.4,-2.2], [0,3.7,-2.2], [0,2,-2.2], [-0.8,-2.6,0.1], [0.8,-2.6,0.1], [-0.8,-4.2,0.1], [0.8,-4.2,0.1], [-0.8,-5.8,0.1], [0.8,-5.8,0.1]]
];
