call{_this addAction["Remove Vehicle", {_box = nearestObjects [HPOS3, ["OPTRE_Ammo_SupplyPod_Empty"], 2] select 0; deleteVehicle _box;}]};

call{_this addAction["Spawn Ammo Pod",{
_box = nearestObjects [HPOS3, ["OPTRE_Ammo_SupplyPod_Empty"], 2] select 0; deleteVehicle _box;
sleep 0.2;
