call{_this addAction["Remove Vehicle", {_box = nearestObjects [FOBAPOS_1, ["OPTRE_Ammo_SupplyPod_Empty"], 2] select 0; deleteVehicle _box;}]};

call{_this addAction["Spawn Ammo Pod",{
_box = nearestObjects [FOBAPOS_1, ["OPTRE_Ammo_SupplyPod_Empty"], 2] select 0; deleteVehicle _box;
sleep 0.2;
_pos = [(getPosATL FOBAPOS_1) # 0, (getPosATL FOBAPOS_1) # 1, (getPosATL FOBAPOS_1) #2 + 0.5];
